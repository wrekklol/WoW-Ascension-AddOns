...
function DRTracker:OnInitialize()
	...
	self.icons = {
		...
		["ctrlstun"] = "Interface\\Icons\\spell_holy_sealofmight",
		["ctrlroot"] = "Interface\\Icons\\spell_nature_stranglevines",		
		["fear"] = "Interface\\Icons\\Spell_Shadow_Possession",
		["disorient"] = "Interface\\Icons\\spell_nature_polymorph",
		["root"] = "Interface\\Icons\\Spell_Frost_FrostNova",
		["horror"] = "Interface\\Icons\\spell_shadow_deathcoil",
		["rndroot"] = "Interface\\Icons\\spell_frost_frostarmor",
